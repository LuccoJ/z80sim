...
const unsigned char g[6] = {117, 49, 58, 158, 4, 126};
...
unsigned char
evalpoly (unsigned char p[255], unsigned char x)
{
...
void rsdecode (unsigned char code[255], unsigned char mesg[249], int* errcode) {
  ...
  unsigned char syn[7], deter, z[4], e0, e1, e2, n0, n1, n2, w0, w1, w2, x0, x[3];
  int sols;
  unsigned char i, j;
